...
REPO_DIR = environ.Path(__file__) - 4  # / One level up from the backend folder
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///reffered")
}
...
ADMINS = [("""Agustin Dahbar""", "agustin@thewebbakers.com")]
